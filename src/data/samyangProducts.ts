...
export const SAMYANG_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    "bestQuotes": [
      "삼양식품 본사 공식 정품의 신뢰할 수 있는 맛",
      "엄선된 원재료로 건강하고 맛있는 한 끼"
    ],
    "storeStocks": [
      {
        "store": "삼양식품 공식몰",
  ...
  },
  {
    ...
    "bestQuotes": [
      "육즙 가득 풍성한 고기 식감과 든든함",
      "간편하게 에어프라이어로 완성하는 별미"
    ],
    "storeStocks": [
      {
        "store": "삼양식품 공식몰",

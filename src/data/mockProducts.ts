...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    subCategory: '커피',
    itemType: 'restaurant',
    image: "https://mmthcoffee.com/files/menu/da61399c92016846027ff7b929ab960f.png",
    releaseDate: '2026.09 신메뉴',
    price: 3200,
    overallRating: 4.7,
    ratingCount: 254,
    searchInfluxCount: 129360,
    stores: ["매머드커피"],
    repurchasePercent: 96,
    calories: 140,
    volume: "M(20oz) / L(32oz)",
    ...
    description: "500ml 용량의 가볍고 열에 강한 PP 재질 리유저블 컵 &nbsp;",
    bestQuotes: ['커피 풍미가 아주 깊고 깔끔해요', '매일 마셔도 부담 없는 맛!']
  },
  {
    id: 'coffee-mmth-350',
    name: "매머드 매트블랙 콜드 텀블러",
    brand: "매머드커피",
    category: '음료',
    subCategory: '커피',
    itemType: 'restaurant',
    image: "https://mmthcoffee.com/files/menu/de175fc26c9283b90a7f7adfa675d1f5.png",
    releaseDate: '2026.09 신메뉴',
    price: 3200,
    overallRating: 4.8,
    ratingCount: 277,
    searchInfluxCount: 129680,
    stores: ["매머드커피"],
    repurchasePercent: 97,
    calories: 140,
    volume: "M(20oz) / L(32oz)",
    ...
    description: "630ml 용량의 고급스러운 무광 매트블랙 텀블러 (빨대 포함) &nbsp;",
    bestQuotes: ['커피 풍미가 아주 깊고 깔끔해요', '매일 마셔도 부담 없는 맛!']
  },
  {
    id: 'burger-mcd-01',

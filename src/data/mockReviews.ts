...
export const INITIAL_REVIEWS: Review[] = [
  ...
  // 10. [간편식] 점보도시락 8인분
  {
    ...
    userLevel: 'Lv.6',
    rating: 5,
    detailedRating: { taste: 4.6, value: 4.9, portion: 5.0, repurchase: 4.7 },
    content: '친구 6명이서 캠핑가서 먹었는데 크기 보고 다들 빵 터졌습니다 ㅋㅋㅋ 양 진짜 엄청나고 원래 도시락 라면의 그 짭짤하고 고소한 국물맛 그대로예요!',
    images: ['https://images.unsplash.com/photo-1612927601601-6638404737ce?w=600&auto=format&fit=crop&q=80'],
    likes: 39,
    isLiked: false,
    commentsCount: 4,
    createdAt: '2026-09-04T20:30:00Z',
    tags: ['#가성비갑', '#캠핑필수품', '#압도적크기'],
  },

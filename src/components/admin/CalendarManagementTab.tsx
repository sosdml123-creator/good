    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-4 py-2.5 bg-purple-600 hover:bg-purple-500 text-white rounded-xl text-xs font-bold flex items-center gap-2 shadow-md shadow-purple-600/20 active:scale-95 transition-all self-start lg:self-auto"
        >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className={`p-4 rounded-2xl border ${cardBg}`}>
          ...
          <div className="mt-2 text-2xl font-bold font-mono">{calendarItems.length}건</div>
        </div>
        <div className={`p-4 rounded-2xl border ${cardBg}`}>

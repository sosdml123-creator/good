...
export const POPULAR_BRANDS: BrandInfo[] = [
  ...
  },
  {
    ...
    bannerImage: 'https://momstouch.co.kr/upload_file/product_info/1781574164-JCDWG.png',
    category: '패스트푸드',
    slogan: '빠르게보다 ALL 바르게! 두툼한 통다리살 치킨버거',
    description: '육즙 가득 바삭한 통다리살 싸이버거와 신선한 수제 비프버거의 성지.',
    officialUrl: 'https://momstouch.co.kr',
    badge: '치킨버거 압도적 1위',
    isPopular: true
  },
  {
  ...
  },
  {
    id: 'dominos',
    name: '도미노피자',
    engName: "Domino's Pizza",
    logo: BRAND_LOGOS_MAP['도미노피자'],
    bannerImage: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=1000&auto=format&fit=crop&q=80',
    category: '패스트푸드',
    slogan: 'Life Food, Domino\'s! 완벽한 한 판의 예술',
    description: '블랙타이거 슈림프, 와일드 와일드 웨스트 스테이크, 포테이토 등 대한민국 No.1 피자 브랜드.',
  ...
  },
  {
    ...
    name: '파파존스',
    engName: 'Papa Johns',
    logo: BRAND_LOGOS_MAP['파파존스'],
    bannerImage: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1000&auto=format&fit=crop&q=80',
    category: '패스트푸드',
    slogan: 'Better Ingredients, Better Pizza! 미국 정통 오리지널 피자',
    description: '수퍼 파파스, 존스 페이버릿, 올미트, 스파이시 치킨랜치 등 진한 치즈와 풍성한 토핑의 정통 아메리칸 피자.',
    officialUrl: 'https://pji.co.kr',
    badge: '미국 정통 프리미엄 피자',
    isPopular: true
  },
  {
    ...
    name: '피자헛',
    engName: 'Pizza Hut',
    logo: BRAND_LOGOS_MAP['피자헛'],
    bannerImage: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=1000&auto=format&fit=crop&q=80',
    category: '패스트푸드',
    slogan: '함께 즐겨요 피자헛! 리치골드와 팬피자의 전설',
    description: '립스테이크 골드바이트, 토핑킹, 케이준 더블쉬림프, 슈퍼슈프림 등 풍성한 프리미엄 피자.',
    officialUrl: 'https://www.pizzahut.co.kr',
    badge: '글로벌 No.1 피자 명가',
    isPopular: true
  },
  {
    id: 'pizzaschool',
    name: '피자스쿨',
    engName: 'Pizza School',
    logo: BRAND_LOGOS_MAP['피자스쿨'],
    bannerImage: 'https://images.unsplash.com/photo-1571407970349-bc81e7e96d47?w=1000&auto=format&fit=crop&q=80',
    category: '패스트푸드',
    slogan: '맛있고 푸짐하게, 착한 가격으로 즐기는 국민 피자',
    description: '포테이토피자, 고구마피자, 까르보네피자, 직화홀릭바이트 등 대한민국 가성비 1등 피자.',
    officialUrl: 'http://pizzaschool.net',
    badge: '국민 가성비 1등 피자',
    isPopular: true
  },
  {
    id: 'pizzaalvolo',
    name: '피자알볼로',
    engName: 'Pizza Alvolo',
    logo: BRAND_LOGOS_MAP['피자알볼로'],
    bannerImage: 'https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?w=1000&auto=format&fit=crop&q=80',
    category: '패스트푸드',
    slogan: '어머니의 정성으로 만드는 천연 흑미 도우 피자',
    description: '단호박피자, 꿈을피자, 어깨피자, 쉬림프&안심골드 등 진도산 흑미 72시간 저온숙성 도우 수제 피자.',
    officialUrl: 'https://pizzaalvolo.co.kr',
    badge: '천연 흑미도우 수제명가',
    isPopular: true
  },
  {
    id: 'banolimpizza',
    name: '반올림피자',
    engName: 'Banolim Pizza',
    logo: BRAND_LOGOS_MAP['반올림피자'],
    bannerImage: 'https://images.unsplash.com/photo-1534308983496-4fabb1a015ee?w=1000&auto=format&fit=crop&q=80',
    category: '패스트푸드',
    slogan: '맛과 토핑을 반올림하다! 특제 갈릭소스의 정점',
    description: '반올림포텐피자, 통마늘불고기, 치즈후라이크림치즈 등 4가지 맛을 한 번에 즐기는 수제 피자.',
    officialUrl: 'https://handmadepizza.co.kr',
    badge: '수제갈릭소스 & 포텐피자',
    isPopular: true
  },
  {
